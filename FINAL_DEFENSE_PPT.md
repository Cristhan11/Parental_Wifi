...
How to use this file: Each section below that starts with “Slide” and a number is one PowerPoint slide. Copy the On-slide (PPT) block into PowerPoint; paste Speaker notes (for us) into PowerPoint’s Notes pane.
