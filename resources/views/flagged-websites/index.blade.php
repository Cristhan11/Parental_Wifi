        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="mb-4 p-4 bg-blue-50 border border-blue-200 rounded-lg">
                <p class="text-sm text-blue-800">
                    <strong>Note:</strong> Flagged websites are monitored but not blocked. When a child visits a flagged website, 
                    it's logged and you'll be notified, but access is still allowed.
                </p>
            </div>
