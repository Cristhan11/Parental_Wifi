{{-- Matches other auth code emails: table layout, slate palette. --}}
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8">
            ...
            <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="max-width:600px; background-color:#ffffff; border-radius:8px; border:1px solid #e2e8f0; overflow:hidden;">
                ...
                <tr>
                    <td style="padding:24px 28px 16px 28px;">
                        ...
                        <h1 style="margin:16px 0 0 0; font-size:22px; font-weight:600; color:#0f172a;">Confirm your new email</h1>
                        <p style="margin:12px 0 0 0; font-size:14px; color:#475569;">Hello {{ $userName }}, someone requested to use <strong style="word-break:break-all;">{{ $newEmail }}</strong> as the sign-in email on Parental WiFi. Use the code below on the profile page to continue. If you did not request this, you can ignore this message.</p>
                    </td>
                </tr>
                <tr>
                        ...
                        <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="background-color:#f8fafc; border:1px solid #e2e8f0; border-radius:8px;">
                            <tr>
                                <td style="padding:20px 24px; text-align:center;">
                                    <p style="margin:0 0 8px 0; font-size:12px; font-weight:600; letter-spacing:0.06em; text-transform:uppercase; color:#64748b;">Your confirmation code</p>
                ...
                <tr>
                    <td style="padding:0 28px 28px 28px;">
                        <p style="margin:0; font-size:13px; color:#64748b;">For your security, do not share this code with anyone.</p>
                    </td>
                </tr>
            </table>
        </td>
