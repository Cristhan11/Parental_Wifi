<x-guest-layout>
    <div class="mb-6">
        ...
        <p class="mt-2 text-sm" style="color: #00000080;">
            A Parent Owner did not approve this parent registration. You cannot access the parent dashboard with this account.
        </p>
    </div>

    @if (! empty($note))
        <div class="mb-4 p-3 rounded-md bg-gray-100 text-sm text-gray-800">
            <strong>Note from Parent Owner:</strong> {{ $note }}
        </div>
    @endif
