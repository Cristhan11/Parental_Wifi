    ...
    <x-slot name="header">
        ...
        <div class="flex items-center justify-between" style="background-color: #FFDE15; padding: 1rem; border-radius: 0.5rem;">
            ...
            <div class="flex space-x-2">
                <a href="{{ route('quizzes.import') }}" class="px-4 py-2 rounded text-white font-medium hover:opacity-90" style="background-color: #10B981;">
                    Import Excel
                </a>
                <a href="{{ route('quizzes.create') }}" class="px-4 py-2 rounded text-white font-medium hover:opacity-90" style="background-color: #EF4444;">
                    + New
                </a>
            </div>
        </div>
